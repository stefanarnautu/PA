public class Main {
    public static void main(String[] args)
    {
        ...
        //Populam instanta
        problem.addEvent("c1",100,8);
        problem.addEvent("c2",100,10);
        problem.addEvent("c3",100,16);
        problem.addEvent("c4",100,16);
        problem.addEvent("c5",100,8);
        problem.addEvent("c6",100,16);
        problem.addEvent("l1",30,8);
        problem.addEvent("l2",30,8);
        problem.addEvent("l3",30,10);
       ...
       // System.out.println(problem.saliDeCurs.get(0).getVideoProjector());
        System.out.println(problem.cursuriSiSeminarii.get(1).getDataStart().getHours());
